...
<head>
	...
	<!-- BOOTSTRAP STYLES-->
    <link href="{{asset('Profile/css/bootstrap.css')}}" rel="stylesheet" />
     <!-- FONTAWESOME STYLES-->
    <link href="{{asset('Profile/css/font-awesome.css')}}" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <link href="{{asset('Profile/js/morris/morris-0.4.3.min.css')}}" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
...
<span class="label label-danger">Danger</span>
    ...
    <!-- JQUERY SCRIPTS -->
    <script src="{{asset('Profile/js/jquery-1.10.2.js')}}"></script>
      <!-- BOOTSTRAP SCRIPTS -->
    <script src="{{asset('Profile/js/bootstrap.min.js')}}"></script>
    <!-- METISMENU SCRIPTS -->
    <script src="{{asset('Profile/js/jquery.metisMenu.js')}}"></script>
     <!-- MORRIS CHART SCRIPTS -->
     <script src="{{asset('Profile/js/morris/raphael-2.1.0.min.js')}}"></script>
    <script src="{{asset('Profile/js/morris/morris.js')}}"></script>
      <!-- CUSTOM SCRIPTS -->
